...
export class UserController {
    ...
    @Get('tree')
    @ApiOperation({summary: 'Retorna a árvore de usuários de acordo com o parentUserId '})
    @ApiResponse({status:200, description: 'Lista encontrada', type: UserParentDto})
    ...
    @ApiResponse({status:200, description: 'Usuario encontrado', type: UserParentDto})
    @ApiResponse({status:401, description: 'Rota não autorizada'})
    ...
    @ApiResponse({status:200, description: 'Usuario atualizado', type: UserParentDto})
